...
const moveSnakeTable = state => (updatePanel({ applePanel: state.applePanel, snakePanel: state.snakePanel }));

const keySnakeTable = (key, state) => (processKey({
  applePanel: state.applePanel,
  snakePanel: state.snakePanel,
  key
}));

const joinSnakeTable = state => (assignPanel({ applePanel: state.applePanel, snakePanel: state.snakePanel }));
